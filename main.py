            ...
            for btn in btns:
                try:
                    if btn.is_displayed() or btn.is_enabled():
                        ...
                        time.sleep(3)
                        log.info("✅ تم قبول شروط الخدمة (Terms of Service)")
